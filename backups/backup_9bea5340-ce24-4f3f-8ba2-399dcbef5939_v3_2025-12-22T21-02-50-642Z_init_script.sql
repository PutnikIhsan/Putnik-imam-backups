...
-- Generated: 2025-12-22T21:02:50.640Z
...
CREATE OR REPLACE FUNCTION public.claim_tafsir_task(p_source_key text, p_worker_id text)
 RETURNS TABLE(id uuid, source_key text, surah integer, ayah_from integer, ayah_to integer, cleaned_text text, char_length integer, class text, status text, attempts integer)
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
AS $function$
